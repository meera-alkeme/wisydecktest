...
<style>
  ...
  .s-agents__photoCap {
    height: 130px;
    border-radius: 16px;
    background: url("https://images.unsplash.com/photo-1604719312566-8912e9227c6a?w=600&q=80&auto=format&fit=crop") center/cover;
    position: relative;
    overflow: hidden;
  }
  ...
  .s-hqi__pushAlertHead .d {
    width: 8px; height: 8px;
    border-radius: 999px;
    background: var(--wisy-lime);
    display: inline-block;
  }
  [data-deck-active] .s-hqi__pushAlertHead .d {
    animation: airDevDot 1600ms ease-out infinite;
  }
  .s-hqi__pushAlertBody {
    font-family: var(--font-sans);
    font-size: 18px;
    font-weight: 600;
    color: var(--wisy-white);
  ...
  .s-cred__card.brand .lbl { color: rgba(255,255,255,0.78); }
  .s-cred__card .fig {
    font-family: var(--font-sans);
    font-weight: 500;
    font-size: 104px;
  ...
  .s-cred__card.brand .fig { color: var(--wisy-lime); }
  .s-cred__card .cap {
    font-family: var(--font-sans);
    font-size: 24px;
    line-height: 1.3;
  ...
  .s-cred__card .cap em { font-style: normal; color: var(--wisy-lime); font-weight: 600; }
  .s-cred__card.brand .cap { color: rgba(255,255,255,0.92); }
  ...
  <section data-label="01 Title">
    <div class="s-title">
      <div class="s-title__left">
        <div>
          <p class="kicker"><span class="dot"></span><span>WISY · FIELD DECK</span></p>
        ...
        <div class="s-title__hook">
          ...
          <p class="sub">One system that sees your shelf, ranks what matters, and tells your teams what to do before they leave the store.</p>
        </div>
        <div class="s-title__meta">
          <span>For CPG &amp; Grocery</span>
          <span class="bar" style="background-color: rgb(255, 253, 253); color: rgb(255, 255, 255)"></span>
          <span>
</span>
          <span class="bar" style="color: rgb(247, 245, 245); background-color: rgb(255, 254, 254)"></span>
          <span>
</span>
        </div>
      </div>
      ...
      <div class="s-ground__photo">
        <div class="s-ground__rep">
          ...
          <div class="s-ground__chips">
            <span class="c">7 apps. 0 talking to each other.</span>
      ...
      <div class="s-ground__right">
        ...
        <div class="s-ground__chaos">
          <div class="s-ground__chaosRow">
            ...
            <div class="lbl" style="font-weight: 500">Audit app: manual photo + tag, 90s 
per shelf</div>
          ...
          <div class="s-ground__chaosRow">
            ...
            <div class="lbl">Promo form: paper PDF, signed at 
checkout</div>
            <span class="tag">offline only</span>
          </div>
          <div class="s-ground__chaosRow">
            <div class="app" style="background: #1a7a4a">D</div>
            <div class="lbl">Check-in system: geo-tag + timestamp, no shelf context</div>
            <span class="tag">siloed</span>
          </div>
          <div class="s-ground__chaosRow">
            <div class="app" style="background: #8b4513">E</div>
            <div class="lbl">Sell-in / sell-out reports: weekly export, 7-day lag</div>
            <span class="tag" style="text-align: right">stale data</span>
          </div>
        </div>

        <p class="s-ground__quote">Reps drown in tabs. Every minute on the phone is a secondary display not placed, a restock not done. The opportunity is gone before the photo reaches HQ.</p>
      </div>
    </div>
  </section>
    ...
    <div class="s-air">
      <div class="s-air__left">
        <div>
          ...
          <p class="s-air__pitch">The <em>cheapest robot</em> on every shelf, lives in the rep's pocket.</p>
        </div>
        ...
        <div>
          ...
          <div class="s-air__caps">
            ...
            <span class="s-air__cap" style="border-color: rgb(255, 255, 255)">
</span>
          </div>
        </div>
      </div>
    ...
    <div class="s-agents">
      <div class="s-agents__head">
        <div>
          ...
          <h2>An <em>AI teammate</em> in every rep's pocket. The most intelligent action every visit.</h2>
        </div>
      ...
      <div class="s-agents__flow">
        ...
        <div class="s-agents__pipe">
          ...
          <div class="s-agents__step">
            ...
            <div class="body">
              ...
              <p class="t">Most Intelligent action</p>
            </div>
        ...
        <div class="s-agents__out">
          <h3>Revenue at stake — every visit</h3>
          <div class="s-agents__outCard dark">
            <p class="v">$500<span class="small"> opportunity</span></p>
            <p class="l">Total recoverable revenue per store visit if all 6 tasks are completed</p>
          </div>
          <div class="s-agents__outCard">
            <p class="v">3 / 6</p>
            <p class="l">Tasks completed — store closed, cooler out of order, no access</p>
          </div>
          <div class="s-agents__outCard" style="border-color: var(--wisy-indigo);">
            <p class="v" style="color: var(--wisy-indigo);">$300</p>
            <p class="l">Gap closed. Logged. Visible to HQ before you leave the parking lot.</p>
          </div>
          <div class="s-agents__outCard" style="background: var(--wisy-gray-50);">
            <p class="v" style="font-size: 28px; letter-spacing: -0.01em;">−30 min</p>
            <p class="l">Per visit returned to the rep. That's time for one more store.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="s-hqi">
      <div class="s-hqi__head">
        <div>
          ...
          <h2>HQI: the shelf, wired straight to HQ.</h2>
        </div>
        <p></p>
      </div>

      <div class="s-hqi__pushAlert">
        <div class="s-hqi__pushAlertHead">
          <span class="d"></span>
          Push alert &middot; 2s ago
        </div>
        <p class="s-hqi__pushAlertBody">OOS cluster — Coca-Cola 2L<br/>38 stores, São Paulo</p>
        <p class="s-hqi__pushAlertRev">+$42,000 recoverable &middot; Field team notified</p>
      </div>
          ...
          <div class="s-hqi__main">
            ...
            <div class="s-hqi__panels">
              <div class="s-hqi__panel">
                <h4>Compliance heatmap — Red = critical, Yellow = at risk, Green = compliant<span class="pill">last 24h</span></h4>
  ...
  <section data-label="07 Convergence">
    <div class="s-conv">
      <div class="s-conv__head">
        ...
        <h2>A fleet of agents, joining your stack into <em>one intelligence layer.</em></h2>
        <p></p>
      </div>
  ...
  <section data-label="08 Credibility">
    <div class="s-cred">
      <div class="s-cred__head">
        <p class="kicker on-dark"><span class="dot"></span><span>Why this team · Why now</span></p>
        <h2>Silicon Valley DNA. <em>Backed by Palantir's founders.</em></h2>
      </div>

      <div class="s-cred__row">
        <div class="s-cred__card brand">
          <p class="lbl">Lead investor</p>
          <p class="fig">8VC</p>
          <p class="cap">The fund started by Palantir's founders.</p>
        </div>
        <div class="s-cred__card">
          <p class="lbl">Innovation velocity</p>
          <p class="fig">Weekly</p>
          <p class="cap">New models ship. In-house teams ship <em>quarterly.</em></p>
        </div>
        <div class="s-cred__card">
          <p class="lbl">The cost argument</p>
          <p class="fig">$900K</p>
          <p class="cap">Redeployed by a customer who replaced <em>16 data scientists.</em></p>
        </div>
      </div>

      <div class="s-cred__logos">
        <div class="s-cred__logo">Palantir<small>Foundational investor</small></div>
        <div class="s-cred__logo">Eight VC<small>$7B fund · lead</small></div>
        <div class="s-cred__logo">NVIDIA<small>Inference · IoT</small></div>
        <div class="s-cred__logo">AWS<small>Compute</small></div>
        <div class="s-cred__logo">SAP · Salesforce<small>Integration partners</small></div>
      </div>
    </div>
  </section>
  ...
  <section data-label="09 Social proof">
    <div class="s-proof">
      <div class="s-proof__photo">
        ...
        <div class="brandStamp">LARGEST BREWER · LATIN AMERICA</div>
      </div>
      <div class="s-proof__right">
        ...
        <div class="s-proof__quote" style="background: var(--wisy-black); border-left: 3px solid var(--wisy-lime); border-radius: 16px; padding: 22px 28px;">
          <p style="color: var(--wisy-white); padding-left: 0; margin-top: 0; padding-top: 16px;">"Everything comes down to execution. You can have the best strategy in the room — if the shelf doesn't reflect it, none of it matters."</p>
          <div class="meta">
            <div class="av" style="background: var(--wisy-lime); color: var(--wisy-black); font-weight: 700;">B</div>
            <div class="who" style="color: var(--wisy-white);">Bernardo — CEO, Iberia<span style="color: rgba(255,255,255,0.6);">LATIN CONSUMER SUMMIT</span></div>
          </div>
        </div>
        ...
        <div class="s-proof__stats">
          <div class="s-proof__stat">
            <p class="v">4,200+</p>
            <p class="l">Stores scanned monthly — Chile, Mexico, Europe, MEEN</p>
          </div>
          <div class="s-proof__stat">
            <p class="v">1.8M</p>
            <p class="l">Shelf photos processed by AIR last quarter alone</p>
          </div>
          <div class="s-proof__stat">
            <p class="v">11</p>
            <p class="l">Countries live — Latin America, Europe &amp; MEEN</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="s-close">
      ...
      <div class="s-close__hero">
        ...
        <div class="s-close__right">
          ...
          <p class="quote">They hired data scientists. We replaced them with agents. <em>You get the $900K back.</em></p>
        </div>
      </div>

      <div class="s-close__cta">
        <div class="who">Wisy &middot; Silicon Valley AI &middot; Eight VC backed<span>wisy.ai &nbsp;·&nbsp; hello@wisy.ai</span></div>
        <div class="next">
          <span>Next step</span>
...
<script>
  ...
  (function buildHeat(){
    ...
    const palette = [
      '#e8f5e9',  // light green — compliant
      '#a5d6a7',  // medium green
      '#fff9c4',  // light yellow — attention needed
      '#ffcc02',  // yellow — warning
      '#ef5350',  // red — critical
    ];
    ...
    for (let i = 0; i < COLS * ROWS; i++) {
      ...
      span.style.background = lime ? '#ef5350' : palette[idx];
